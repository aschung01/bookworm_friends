...
class Library extends GetView<LibraryController> {
  ...
  void _onBookDeletePressed(String isbn) {
    getDeleteBookBottomSheet(onDeletePressed: () async {
      ...
      LibraryController.to.libraryMode.value = LibraryMode.library;
      LibraryController.to.getLibrary();
    });
  }
  ...
  void _onEditLibraryPressed() {
    controller.libraryMode.value = LibraryMode.editLibrary;
  }

  void _onEditShelfPressed() {
    controller.libraryMode.value = LibraryMode.editShelf;
  }
                                                                    ...
                                                                    return Hero(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          BookWidget(
                                                                            imageUrl:
                                                                                _.library[_.shelf[shelf]]![index]['thumbnail'],
                                                                            onTap:
                                                                                () {
                                                                              BookDetailsController.to.bookInfo.clear();
                                                                              BookDetailsController.to.bookInfo.addAll(_.library[_.shelf[shelf]]![index]);
                                                                              BookDetailsController.to.shelf.value = _.shelf[shelf];
                                                                              BookDetailsController.to.getBookDetails();
                                                                              BookDetailsController.to.tabController.index = 0;
                                                                              BookDetailsController.to.self.value = true;
                                                                              Get.toNamed('/details');
                                                                            },
                                                                            onLongPress:
                                                                                _onEditLibraryPressed,
                                                                          ),
                                                                          if (_.library[_.shelf[shelf]]![index]['status'] ==
                                                                              1)
                                                                            Positioned(
                                                                              top: 0,
                                                                              right: 8,
