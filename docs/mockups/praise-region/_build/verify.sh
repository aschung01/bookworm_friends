...
cat _build/stub.js /tmp/praise_region.js > /tmp/praise_region_load.js
node /tmp/praise_region_load.js
echo "load ok (no top-level render errors)"

echo
echo "== assertions =="
cat _build/stub.js /tmp/praise_region.js _build/assert.js > /tmp/praise_region_assert.js
node /tmp/praise_region_assert.js
